...
{Este capítulo tratará sobre comportamiento organizativo (\textit{Organizational Behaviour}, OB). Se tocarán 4 puntos: selección de personal, desarrollo de personal, motivación de personal y bienestar de personal. Esta parte afectará a varias partes del \nameref{fig:3.1} (figura \ref{fig:3.1}):}
